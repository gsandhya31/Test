...
File changes
- brd/annex-scope-register.md: row 42 question replaced by "Phase 1: manual analyst check; automated in Phase 2 with 3.13". Rows 20 and 29: restore the unresolved sub-questions (2.9 six vs seven attributes; 3.3 three vs four fields).
- brd/01-capability-catalogue.md: replace the stale FO-systems passage with the Phase 1 position above; add sub-modes to every skill that has more than one behaviour; remove open points now decided or ruled as standing rules; keep the rest.
