...
- NTIs: Unstructured to Structured and Compare and Match are reused (the latter extended for sub-mode (b)); a new NTI is raised for each of the other seven skills the CSG to-bes use.
